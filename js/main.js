...
for (var i = 0; i < pokemons.length; i++) {
  ...
  newItem.style.backgroundColor = "#42b289bf";
  ...
  var newSpanwChance = document.createElement("p");
  var newAvgSpanw = document.createElement("p");
  var newSpanwTime = document.createElement("p");
  var newMulti = document.createElement("p");
  var newWeaknes = document.createElement("p");
  var newNextEv = document.createElement("strong");
  ...
  newItem.appendChild(newCandyCount);
  newItem.appendChild(newEgg);
  newItem.appendChild(newSpanwChance);
  newItem.appendChild(newAvgSpanw);
  newItem.appendChild(newSpanwTime);
  newItem.appendChild(newMulti);
  newItem.appendChild(newWeaknes);
  //   newItem.appendChild(newNextEv);
  newItem.appendChild(newNextEv)
  newImg.src = "http://www.serebii.net/pokemongo/pokemon/001.png";

  // for(img of pokemons[i]['img']){
  // newImg.src = 'img'
  // }
  ...
  newName.textContent = `Name: ${pokemons[i]["name"]}`;
  newType.textContent = `Type: ${pokemons[i]["height"]}`;
  newHeight.textContent = `Height: ${pokemons[i]["height"]}`;
  newWeight.textContent = `Weight: ${pokemons[i]["weight"]}`;
  newCandy.textContent = `Candy: ${pokemons[i]["candy"]}`;
  newCandyCount.textContent = `Candy_count: ${pokemons[i]["candy_count"]}`;
  newEgg.textContent = `Egg: ${pokemons[i]["egg"]}`;
  newSpanwChance.textContent = `Spanw_chance: ${pokemons[i]["spawn_chance"]}`;
  newAvgSpanw.textContent = `Avg_spawns: ${pokemons[i]["avg_spawns"]}`;
  newSpanwTime.textContent = `Spawn_time: ${pokemons[i]["spawn_time"]}`;
  newMulti.textContent = `Multipliers: ${pokemons[i]["multipliers"]}`;
  newWeaknes.textContent = `Weaknees: ${pokemons[i]["weaknesses"]}`;
  //   newNextEv.textContent = `Next_evolution: ${pokemons[i]["next_evolution"]}`;
  // newNextEv.textContent = pokemons[i]['next_evolution']
}
